...
<body itemscope itemtype="http://schema.org/WebPage" <?php body_class(); ?> dir="<?php if (is_rtl()) echo "rtl"; else echo "ltr"; ?>">
	...
	<header itemscope itemtype="http://schema.org/WPHeader" id="masthead" role="banner" data-stellar-background-ratio="0.5" class="header header-style-one site-header">
		...
		<div class="overlay-layer-nav <?php if(!empty($fixedheader)) {echo esc_attr($fixedheader);} ?>">
			...
			<!-- STICKY NAVIGATION -->
			<div class="navbar navbar-inverse navbar-fixed-top sticky-navigation appear-on-scroll">
				<!-- CONTAINER -->
				<div class="container">
					...
					if ( !is_front_page() ) {
						...
						if(has_post_thumbnail()){
							...
							<br/><br/>
							<header class="entry-header1" style="background: linear-gradient(to bottom, rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(<?php echo $src[0]; ?>);">
								<br/> <br/> <br/>

								<?php the_title( '<h1 class="" itemprop="headline" align="center">', '</h1>' ); ?>
