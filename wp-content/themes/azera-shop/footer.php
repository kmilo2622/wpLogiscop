    ...
    <footer itemscope itemtype="http://schema.org/WPFooter" id="footer" role="contentinfo" class = "footer grey-bg">
        ...
        <div class="container">
          ...
          <div class="powered-by">
              <p><b>Celular: </b>321 928 3242<br/>
              <p><b>Teléfono: </b>476 4805<br/>
							<p><b>Email: </b>contacto@aycgrupoempresarial.com<br/>
              <p><b>Horarios de Atención presencial: </b>
              <br/>Lunes a Viernes: 8:00 am a 5:00 pm</p>
              <p>Sábados: 9:00 am a 1:00 pm</p>
              <p><b>Dirección: </b>Cra 17 B # 111 Of 201</p>
              <p><b>Bogotá D.C</b></p>
              <hr/>
            <p>Página Web Desarrollada por:
	        	<a href="http://www.johnarij.ml/" target="_blank">John Arij</a></p>
	        </div>

	        <!--div class="powered-by">
	        	<?php printf(
					__( '%1$s powered by %2$s', 'azera-shop' ),
					sprintf( '<a href="http://www.johnarij.ml/" rel="nofollow">%s</a>', esc_html__( 'John Arij', 'azera-shop' ) ),
